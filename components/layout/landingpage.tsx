  ...
  return (
    <main className="min-h-screen w-full overflow-x-hidden">
      ...
      <section className="py-24 bg-gradient-to-b from-green-900 via-green-800 to-green-900 text-white w-full">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <SectionHeader>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-yellow-200 inline-block w-full text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <AnimatedCard key={index} delay={index * 0.2}>
                <div className="bg-white/5 p-8 rounded-2xl backdrop-blur-lg transform transition-all duration-300 hover:bg-white/10 group hover:-translate-y-1 border border-white/10 h-full">
                  ...
                  <h3 className="text-2xl font-semibold mb-4 text-yellow-400 group-hover:text-yellow-300 transition-colors">{feature.title}</h3>
                  <p className="text-gray-200 leading-relaxed group-hover:text-white transition-colors">{feature.description}</p>
                </div>
              </AnimatedCard>
            ))}
          </div>
      ...
      <section className="py-24 bg-yellow-400 relative overflow-hidden w-full">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          ...
          >
            ...
            <Link
              href="/register"
              className="bg-green-600 hover:bg-green-700 text-white px-12 py-5 rounded-lg text-xl font-semibold transition transform hover:scale-105 inline-flex items-center gap-3 hover:shadow-lg"
            >
              Start Your Journey
